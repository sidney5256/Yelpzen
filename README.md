# Yelpzen
Recreation of Yelp using React and Mapzen tools
...
Unfortunately it will be different after every build. You can express support for fixing this on Windows in this issue.
